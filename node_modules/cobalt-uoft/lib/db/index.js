  ...
  _https2.default.get(url, function (res) {
    ...
    res.on('end', function () {
      ...
      _mongoose2.default.connection.db.collection(collection).remove(function (e, count) {
        ...
        // var shell = _child_process2.default.spawn('mongoimport.exe', ['-d', _mongoose2.default.connection.name, '-c', collection, '--host', _mongoose2.default.connection.host, '--port', _mongoose2.default.connection.port, '--file', filePath]);
